    ...
    new Promise((resolve, reject) => {
      try {
        ...
        Model.findAndCountAll(skills, {
          ...
          .catch((err) => {
            reject(
              ErrorHelpers.errorReject(err, "getListError", "skillservice")
            );
          });
      } catch (err) {
        reject(ErrorHelpers.errorReject(err, "getListError", "skillservice"));
      }
    }),
  get_one: (param) =>
    new Promise((resolve, reject) => {
      try {
        ...
        Model.findOne(skills, {
          ...
          .catch((err) => {
            reject(
              ErrorHelpers.errorReject(err, "getInfoError", "skillservice")
            );
          });
      } catch (err) {
        reject(ErrorHelpers.errorReject(err, "getInfoError", "skillservice"));
      }
    }),
  create: async (param) => {
    let finnalyResult;
    ...
    try {
      ...
      ErrorHelpers.errorThrow(error, "crudError", "skillservice");
    }
    ...
    try {
      ...
      if (!foundTopic) {
        ...
        const wardAfterDelete = await Model.findOne(skills, {
          ...
          ErrorHelpers.errorThrow(err, "crudError", "skillservice");
        });
